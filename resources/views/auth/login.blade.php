                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form role="form" method="POST" action="{{ route('login') }}" class="user">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                <input type="checkbox" class="custom-control-input" id="customCheck" id="remember"  {{ old('remember') ? 'checked' : '' }}>
